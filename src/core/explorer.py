...
from src.core.models import WebResource, ArchiveStatus, SearchQuery
from src.core.ollama_client import OllamaClient
from src.core.downloader import WebDownloader
from src.web.screenshot import ScreenshotCapture
